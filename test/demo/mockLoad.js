...
import mock from '../../../../test/demo/mock.json';
...
const ExplorerActions = {
  ...
  execSuccess: function (explorer, response) {
    ...
    response.query = JSON.parse('{"analysis_type":"count","event_collection":"content","group_by":["feed.name","app.baseUrl"],"timezone":"US/Eastern","filters":[{"property_name":"account.id","operator":"eq","property_value":2649}],"timeframe":{"start":"2017-01-01T00:00:00.000","end":"2019-01-01T00:00:00.000"}}');
    ...
    updates.metadata.visualization.chart_type = 'table';
