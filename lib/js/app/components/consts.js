...
export const DEFAULT_TIMEFRAME_ABSOLUTE_VALUE = {
  start: `${moment().subtract(1, 'day').format('YYYY-MM-DD')}T${moment(moment().format('YYYY-MM-DD')).format('HH:mm')}:00.000Z`,
  end: `${moment(moment().format('YYYY-MM-DD')).format('YYYY-MM-DD')}T${moment(moment().format('YYYY-MM-DD')).format('HH:mm')}:00.000Z`,
};
...
export const TAB_INTERVAL_STANDARD = 0;
export const TAB_INTERVAL_CUSTOM = 1;
export const TAB_EXTRACTION_PREVIEW = 0;
export const TAB_EXTRACTION_BULK = 1;

export const EXTRACTION_PREVIEW_EVENTS_LIMIT = 100;
